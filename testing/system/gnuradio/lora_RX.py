...
class lora_RX(gr.top_block):
    ...
    def __init__(self):
        ...
        self.lora_sdr_frame_sync_0 = lora_sdr.frame_sync(int(center_freq), bw, sf, impl_head, [0x12], (int(samp_rate/bw)),8)
        ...
        self.connect((self.lora_sdr_hamming_dec_0, 0), (self.lora_sdr_crc_verif_0_0, 0))
